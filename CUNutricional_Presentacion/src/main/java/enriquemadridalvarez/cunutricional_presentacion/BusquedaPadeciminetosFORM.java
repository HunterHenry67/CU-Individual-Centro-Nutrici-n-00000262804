...
public class BusquedaPadeciminetosFORM extends javax.swing.JFrame {
    ...
    /**
     * Creates new form BusquedaPadeciminetosFORM
     */
    public BusquedaPadeciminetosFORM() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusquedaPadeciminetosFORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BusquedaPadeciminetosFORM().setVisible(true);
            }
        });
    }
